...
DIR="./public/images/jersey_day"
OUTPUT="./data/jersey_day.json"
...
all_files=$(ls "$DIR" | grep -E 'jersey[0-9]+' | sort -V)
...
for file in "${sorted_files[@]}"; do
    ...
    cat >> "$OUTPUT" <<EOF
  {
    "id": $id,
    "type": "$type",
    "url": "/images/jersey_day/$file",
    "caption": "Jersey Day $type $number",
    "studentId": $number
  }
EOF
