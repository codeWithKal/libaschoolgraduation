...
export default function AdminMemories() {
    ...
    try {
      await Promise.all(
        selectedMemories.map((id) =>
          fetch(`/api/memories?id=${id}&day=${selectedDay}`, {
            method: "DELETE",
          }),
        ),
      );
  ...
  // Handle keyboard shortcut for saving caption
          ...
          {filteredMemories.map((memory, index) => (
            ...
            >
              ...
              <div className="p-4 space-y-3">
                {/* ✅ CAPTION - Edit Mode or Display Mode */}
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    ...
                    className="flex-1 bg-red-600/10 hover:bg-red-600/20 text-red-400 py-2 rounded-xl flex items-center justify-center gap-1.5 text-xs font-medium transition-colors"
                  >
                    <Trash2 size={12} />
                    Delete
                  </button>
