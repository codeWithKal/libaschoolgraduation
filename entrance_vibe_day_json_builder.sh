...
DIR="./public/images/entrance_vibe_day"
OUTPUT="./data/entrance_vibe_day.json"
...
all_files=$(ls "$DIR" | grep -E 'entrance_vibe_[0-9]+' | sort -V)
...
for file in "${sorted_files[@]}"; do
    ...
    cat >> "$OUTPUT" <<EOF
  {
    "id": $id,
    "type": "$type",
    "url": "/images/entrance_vibe_day/$file",
    "caption": "Entrance Vibe Day $type $number",
    "studentId": $number
  }
EOF
